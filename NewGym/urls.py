...
urlpatterns = [
    ...
    path('general_progression/', general_progression, name='general_progression'),
    path('exercise_progression/', exercise_progression, name='exercise_progression'),
    path('sets_per_muscle/', sets_per_muscle, name='sets_per_muscle'),
